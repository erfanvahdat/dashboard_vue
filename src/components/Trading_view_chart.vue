  ...
  <div class="flex flex-col ml-[150px] mr-2 h-[94vh]">
        ...
        <div class="flex justify-between items-center w-full bg-blue-600 p-2 rounded">
          ...
          <div class="dropdown dropdown-hover">
            ...
            <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow">
              <!-- Dropdown list dynamically populated from availableSymbols -->
              <li class="bg-black hover:bg-blue-500" v-for="symbol in availableSymbols" :key="symbol.value" @click="updateChart(index, 'top', symbol.value, symbol.label)">
                <a>{{ symbol.label }}</a>
              </li>
    ...
    <div class="flex justify-center m-2 h-1/2">
      <div v-for="(value, key, index) in symbolsBottom" :key="index" class="flex flex-col items-center mx-1.5">
        <!-- header section -->
        <div class="flex justify-between items-center w-full bg-blue-600 p-2 rounded">
          <div :id="'ticker-name-bottom-' + index" class="font-bold text-white">{{ key }}</div>
          ...
          <div class="dropdown dropdown-hover">
            ...
            <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow">
              <!-- Dropdown list dynamically populated from availableSymbols -->
              <li v-for="symbol in availableSymbols" :key="symbol.value"
